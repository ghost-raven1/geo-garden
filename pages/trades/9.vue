<template>
  <div class="container">
    ...
    <ul class="uk-subnav uk-subnav-pill">
        <li class="uk-active" uk-filter-control=".tag-common"><a href="#">Информация по зоне</a></li>
        <li uk-filter-control=".tag-map"><a href="#">Техническая карта</a></li>
        <li uk-filter-control=".tag-events"><a href="#">Интерактивная карта</a></li>
    </ul>
    <ul class="field-info-filter uk-child-width-1-1 uk-child-width-1-1@m uk-text-center" uk-grid>
        <li class="tag-common">
            <div class="uk-card uk-card-default uk-card-body">Площадь зоны: 247м2</div>
        </li>
        <li class="tag-map">
